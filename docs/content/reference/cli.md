...
```
deckofcards <command> [arguments] [flags]
```

Run `deckofcards <command> --help` for the full flag list on any command. This
...
per operation you declare in `deckofcards/domain.go`.
