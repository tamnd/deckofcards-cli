...
Most of these come down to network reality or how deckofcards serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

deckofcards rate-limits like any public site. deckofcards already paces
...
Where a surface is gated, deckofcards reads a cookie or token you supply
...
`deckofcards`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what deckofcards actually did
