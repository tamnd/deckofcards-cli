...
func TestHostWiring(t *testing.T) {
	...
	if want := "deckofcards://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("deckofcards", "about")
	if err != nil || got.String() != "deckofcards://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want deckofcards://page/about", got.String(), err)
	}
}
